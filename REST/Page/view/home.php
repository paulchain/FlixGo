<div class="col-md-12 d-flex justify-content-center align-items-center homie no-gutters">
    <header>
        <div class="container">
            <div class="row">
            <div class="col">
                ...
                <figcaption><i class="fas fa-arrows-alt-h"></i></figcaption>
                </figure>
            </div>
            </div>
        </div>
    ...
    <section class="home">
        <div class="container">
            <div class="row">
                <div class="home-main">
                    <div class="col-6 col-md-3 items"><a href="index.php?page=catalog">
                        <div class="btn btn-home"><i class="fas fa-th-large"></i>
                        <p>DANH MỤC</p>
                        </div></a></div>
                    <div class="col-6 col-md-3 items"><a href="index.php?page=movie">
