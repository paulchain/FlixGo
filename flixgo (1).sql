...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 08, 2018 lúc 05:23 PM
...
INSERT INTO `catalog` (`id`, `location`, `name`) VALUES
(37, 0, 'Phim Hành Động'),
(38, 0, 'Phim Hài Hước '),
(39, 0, 'Phim Cổ Trang'),
...
INSERT INTO `movie` (`id`, `name`, `evaluate`, `view`, `release_year`, `running_time`, `id_country`, `short_description`, `description`, `image`, `clip_SD`, `clip_HD`, `clip_FHD`, `age`, `resolution`, `id_cata`) VALUES
